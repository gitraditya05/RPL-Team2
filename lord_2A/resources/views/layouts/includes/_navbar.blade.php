            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu notifications">
                        <li><a href="#" class="notification-item"><span class="dot bg-warning"></span>System space is full</a></li>
                ...
                <li class="dropdown">
                    {{--Profil: <img src="{{asset('admin/assets/img/user.png')}}" class="img-circle" alt="Avatar"> --}}
